...
$cmd="perl $SE/SEGF.pl -fq1 $fq1 -fq2 $fq2 -bed $fusion_bed -odir $outdir/fusion_SE -trim_len 10  1>/dev/null 2>&1 \n";
$cmd.="rm -r $outdir/fusion_SE/tmp $outdir/fusion_SE/Deal $outdir/fusion_SE/Deal_fastq \n";
